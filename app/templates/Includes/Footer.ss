<!--     FOOTER -->
<img class="footerimg " src="$AbsoluteBaseURL/images/footer01.png " alt="footerimg ">
                    ...
                    <div class="card_footer_title_nav text-center">
                      ...
                      <div class="card-footer-body">
                        ...
                        <ul class="img-footer2 text-center">
                            ...
                            <li>  <a href="$AbsoluteURL/about/certifications"><img src="$AbsoluteBaseURL/images/hs2.jpg" alt="Telarc Quality" >      </a></li>
                            <li><a href="$AbsoluteURL/about/certifications"><img src="$AbsoluteBaseURL/images/hs3.jpg" alt="Telarc Environment" > </a></li>
                              <li> <a href="$AbsoluteURL/about/certifications"><img src="$AbsoluteBaseURL/images/hs1.jpg" alt="Telarc Health and Safety"> </a></li>
