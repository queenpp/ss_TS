<%-- static banner for mobile view --%>
<div class="staticMobileBannerImage hide">
    <% if $bannerImage %>
    <img class="staticBgImg" src="$bannerImage.URL" alt="static mobile image">
    <% end_if %>
</div>
    ...
    <ol class="carousel-indicators ">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item<% if $First %> active<% end_if %>">            
                <a href="$Link"><img class="second-slide " src="$BannerImages.URL" alt="$Pos slide">
                </a>
                <%-- $CarouselImages --%>
                <% if $Title  %>
                <div class="container">
        ...
        <div class="row ">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 homeLinks">
                    ...
                    <div class="card">
                        <div class="text-center">
                            <div id="PromoVideoThumbnail">
                                <img src="$ThemeDir/images/promoVideoThumbnail.jpg" alt="Call to Actions" id="innerPromoVidThumbnail">
                                <img src="$ThemeDir/images/playing.png" alt="playingButton" id="homeplayingButton">
                            </div>
                ...
                <a href="$Link">
                    <div class="card">
                        <div class="text-center">
                            <img class="BannerIcons " src="$HomepageIconImages.URL" alt="$Pos banner" >
                            <div class="card-body text-center">
                                <p class="card-text ">$Description</p>
                            </div>
